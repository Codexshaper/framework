...
if ( ! $show_nav || count($tabs) < 1 ) {
    return;
}
?>

<div class="cxf--option-tabs">
    ...
    ?>
        ...
        <?php if ( empty( $tab['children'] ) ): ?>
            <li class="cxf--tab-item">
                <button type="button" class="cxf--tab-button" data-tab-id="<?php echo esc_attr( $tab_id ); ?>">
                    <?php if($tab_icon): ?>
        ...
        <?php endif; ?>
            ...
            <li class="cxf--tab-item cxf--tab-has-children">';
                ...
                <ul>
                    ...
                    ?>
                        <li>
                            <button type="button" class="cxf--tab-button" data-tab-id="<?php echo esc_attr( $children_id ); ?>">
